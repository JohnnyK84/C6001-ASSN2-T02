...
if (localStorage.length == 0)  {
    var weatherUrl = "http://api.openweathermap.org/data/2.5/forecast?q=christchurch&appid=627c45bdea11c60f24e536fd8aa8328a&units=metric";
    $('#city2').text("Christchurch");
    $.getJSON(weatherUrl,
    function (data) {
        var tr;
